<?php 
  ...
  $get_user = mysqli_query($conn, "SELECT `username` , `email` , `avatar` , `role` FROM `users` WHERE `user_id` = '$_SESSION[id]'");
   ...
   $userer = mysqli_num_rows($users);
   
    $comments = mysqli_query($conn, "SELECT * FROM `comments` ");
   $comments_users = mysqli_num_rows($comments);
		     ...
		     <div class="row">
		        <div class="col-md-3">
				  <div class="panel panel-primary">
					  <div class="panel-heading">أهلا وسهلاً بك يا : <?php echo ucwords($user['username']);  ?> </div>
					    <div class="panel-body">
						  <div class="text-center">
						         <img src="../<?php echo $user['avatar'];  ?>" width="60%" />
								 <hr>
						  </div>
						  <div class="text-center">
				...
				<div class="panel panel-success">
					  <div class="panel-heading">المقالات </div>
					    <div class="panel-body">
                           <div class="col-md-8">
						       <i class="fa fa-list-alt fa-5x " style="color: #81aeaf;" aria-hidden="true"></i>
						   </div>
						   <div class="col-md-4">
						      <p><b> <?php echo $post;  ?><b/></p>
						   </div>
					    </div>
						 <div class="panel-footer text-center"><i class="fa fa-eye" aria-hidden="true"></i> <a href="" >مشاهدة</a></div>
					</div>
				</div>
				<div class="col-md-3">
				<div class="panel panel-danger">
					  <div class="panel-heading">التعليقات  </div>
					    <div class="panel-body">
                           <div class="col-md-8">
						       <i class="fa fa-comments fa-5x " style="color: #d6537c;" aria-hidden="true"></i>
						   </div>
						   <div class="col-md-4">
						      <p><b><?php echo $comments_users; ?><b/></p>
						   </div>
					    </div>
						 <div class="panel-footer text-center"><i class="fa fa-eye" aria-hidden="true"></i> <a href="comment.php" >مشاهدة</a></div>
					</div>
				</div>
				<div class="col-md-3">
				<div class="panel panel-info">
					  <div class="panel-heading"> الأعضاء</div>
					    <div class="panel-body">
                           <div class="col-md-8">
						       <i class="fa fa-users fa-5x " style="color: #2fa05d;" aria-hidden="true"></i>
						   </div>
						   <div class="col-md-4">
						      <p><b> <?php echo $userer;  ?><b/></p>
						   </div>
					    </div>
						 <div class="panel-footer text-center"><i class="fa fa-eye" aria-hidden="true"></i> <a href="" >مشاهدة</a></div>
					</div>
				 ...
				 <div class="panel panel-info">
					  ...
					  <div class="panel-body">
						...
						<thead>
						 ...
						 <tbody>
			 <?php 
						 $posts = mysqli_query($conn,"SELECT * FROM `posts` p INNER JOIN `users` u WHERE p.author = u.user_id ORDER BY `post_id` DESC LIMIT 4");
						 $num = 1;
							...
							echo '
							 <tr>
							   <td>'.$num.'</td>
								...
								<td>'.($post['status'] == 'dreft' ? '<a href="posts.php?status=puplished&post='.$post['post_id'].'" class="btn btn-success btn-xs ">نشر</a>' : '<a href="posts.php?status=dreft&post='.$post['post_id'].'" class="btn btn-info btn-xs">تعطيل</a>').'</td>	
			 ...
			 ?>
				 ...
				 <div class="panel panel-warning">
					  ...
					  <div class="panel-body">
							  ...
							  <tbody>
							<?php 
							 $users = mysqli_query($conn,"SELECT * FROM `users` ORDER BY `user_id` DESC LIMIT 4");
							 $num = 1;
